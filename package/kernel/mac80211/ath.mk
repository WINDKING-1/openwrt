...
define KernelPackage/ath11k-ahb
  ...
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/ath11k
  DEPENDS+= @TARGET_qualcommax @(PACKAGE_kmod-ath11k||PACKAGE_kmod-ath11k-smallbuffers) +kmod-qrtr-smd
...
define KernelPackage/ath11k-pci
  ...
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/ath11k
  DEPENDS+= @PCI_SUPPORT +kmod-qrtr-mhi @(PACKAGE_kmod-ath11k||PACKAGE_kmod-ath11k-smallbuffers)
