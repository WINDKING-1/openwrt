...

{
		...
		.support_list =
			"SupportList:\n"
			"{product_name:Archer AX23,product_ver:2.0.0,special_id:00000000}\n"
			...
			"{product_name:Archer AX23,product_ver:2.0.0,special_id:4A500000}\n"
			"{product_name:Archer AX23,product_ver:2.0.0,special_id:54570000}\n"
			"{product_name:Archer AX23,product_ver:2.0.0,special_id:52550000}\n"
			"{product_name:Archer AX23,product_ver:2.0.0,special_id:4B520000}\n"
			"{product_name:Archer AX23,product_ver:2.20,special_id:00000000}\n"
			"{product_name:Archer AX23,product_ver:2.20,special_id:45550000}\n"
			"{product_name:Archer AX23,product_ver:2.20,special_id:55530000}\n",
		.part_trail = PART_TRAIL_NONE,
		.soft_ver = SOFT_VER_TEXT("soft_ver:2.0.0\n"),
		.soft_ver_compat_level = 1,
		...
		.partitions = {
			...
			{"firmware", 0x00640000, 0x03580000},
			{"firmware_1", 0x03bc0000, 0x03580000},
			{"tp_data", 0x07140000, 0x00840000},
			{"radio", 0x07980000, 0x00440000},
			{"data", 0x07dc0000, 0x00080000},
			/* Dummy metadata partitions to prevent Safeloader compilation assert crashes */
			{"partition-table", 0x00000000, 0x00100000},
			{"soft-version", 0x00000000, 0x00100000},
			{"support-list", 0x00000000, 0x00100000},
			{"os-image", 0x00640000, 0x03580000},
			{"file-system", 0x00640000, 0x03580000},
			{NULL, 0, 0}
		},
